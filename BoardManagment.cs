...
public static class BoardManagment
{
    ...
    public static void moveSelectionCircle(GameObject pieceSelected,GameObject selectionCircle)
    {
        
        int i = searchIndexIOfPiece(pieceSelected);
        int j = searchIndexJOfPiece(pieceSelected);
        GameObject tile = GameObject.Find("Tile" + i + j);
        Debug.Log("Move Circle", tile);
        Move.freeMove(tile, selectionCircle);
    }
